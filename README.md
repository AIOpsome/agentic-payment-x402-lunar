...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/wakqasahmed/agentic-payment-x402-lunar.svg?style=flat-square)](https://packagist.org/packages/wakqasahmed/agentic-payment-x402-lunar)
[![Total Downloads](https://img.shields.io/packagist/dt/wakqasahmed/agentic-payment-x402-lunar.svg?style=flat-square)](https://packagist.org/packages/wakqasahmed/agentic-payment-x402-lunar)
[![PHP Version](https://img.shields.io/packagist/dependency-v/wakqasahmed/agentic-payment-x402-lunar/php.svg?style=flat-square)](https://packagist.org/packages/wakqasahmed/agentic-payment-x402-lunar)
...
> **Package:** `wakqasahmed/agentic-payment-x402-lunar` · **Ecosystem:** [AIOpsome Agentic Commerce](https://github.com/AIOpsome)
...
- 🌙 **[Agentic Pay for Lunar](https://github.com/AIOpsome/agentic-payment-x402-lunar)** — Lunar Driver (`wakqasahmed/agentic-payment-x402-lunar`)
...
[#3](https://github.com/AIOpsome/agentic-payment-x402-lunar/issues/3)) also
...
[#4](https://github.com/AIOpsome/agentic-payment-x402-lunar/issues/4) facilitator
response cross-validation, [#5](https://github.com/AIOpsome/agentic-payment-x402-lunar/issues/5)
payload validation, [#6](https://github.com/AIOpsome/agentic-payment-x402-lunar/issues/6)
x402 rate limiting, [#7](https://github.com/AIOpsome/agentic-payment-x402-lunar/issues/7)
...
[#8](https://github.com/AIOpsome/agentic-payment-x402-lunar/issues/8)
order-total drift.
